-- ============================================================================
-- Fix: notify_new_comment and notify_admin_status_change insert into
-- public.notifications, which has RLS allowing only service_role to INSERT.
-- Recreate both functions with SECURITY DEFINER so trigger-driven inserts
-- succeed (same pattern as civisto 20251012170000_notifications_security_definer).
-- ============================================================================
...
CREATE OR REPLACE FUNCTION notify_admin_status_change()
RETURNS TRIGGER
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
